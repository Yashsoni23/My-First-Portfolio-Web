...
const Home = () => {
    ...
    const changeBgFun = () => {
        changeBg.current.classList.toggle('form_Bg_change');
    }
        ...
        <>
                ...
                <div className="Banner">
                    <div className='SometxtBox'>
                        <div className="Sometxt" >
                            <h1 className='txt'  data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div className="poster_container1"  data-aos="" data-aos-duration="1000">
            ...
            <section className="About" id='About'  data-aos="fade-up" data-aos-duration="1000" >
                ...
                <div className="DivContainer" >
                    <div className="ImageOuterBox" data-aos="fade-up" data-aos-duration="1500">
                        <div className="ImageInnerBox ImageInnerBox_About"/>
                    </div>
                    <div className="AboutOuterContainer" data-aos="fade-up" data-aos-duration="1500">
            ...
            <section id="Projects">
                ...
                > <h2 className='Head2'>Pro<span className='ul2'>je</span>cts</h2></div>
                <div className="projectBox">
                    <div className="Card1" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div className="Card3" data-aos="fade-up" data-aos-duration="2000">
                ...
                <div className="triangle_1" data-aos="fade-up"
            ...
            <section className="Sketches">
                ...
                <div className="Banner2">
                    <div className="poster_container" data-aos="zoom-in" data-aos-duration='1000'>
                        <div className="Poster2" />
                    </div>
                    <div className="SkillBox">
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-10"><div className="overlay">95%</div><div className="SkillName">HTML</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-11"><div className="overlay">92%</div><div className="SkillName">CSS</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-12"><div className="overlay">60%</div><div className="SkillName">JS</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-13"><div className="overlay">75%</div><div className="SkillName">J-QUERY</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-14"><div className="overlay">80%</div><div className="SkillName">C</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-15"><div className="overlay">75%</div><div className="SkillName">C++</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-16"><div className="overlay">64%</div><div className="SkillName">REACTJS</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-17"><div className="overlay">50%</div><div className="SkillName">NEXTJS</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset progress-18"><div className="overlay">50%</div><div className="SkillName">PHP</div></div>
                        <div data-aos="zoom-in" data-aos-duration="1500" className="skillset "><div className="LIlogo"><FaLinkedinIn />
                    ...
                    <Slider imgData={imgData} data-aos-duration="1000" />
            ...
            <section className=" section_Contect" id="Contact">
                ...
                <div className="Contact_header" data-aos="fade-up" data-aos-duration='1000'>
                    <h1 className="Contact_Head">Get in Touch</h1>
                </div>
                <div className="Contact_container">

                    <div className="Contact_flex_container" data-aos="fade-up" data-aos-duration='1000'>
                        <form action="https://formspree.io/f/xpznagoe" method="POST">
                            <div className="form_container" >
                                <div className="form_container_inner" ref={changeBg}>
                                    <div className=" feild_container " ref={changeBg}>
                                        <legend ref={changeBg}> Name*</legend>
                                        <label htmlFor="Name" className="label" min="5" ref={changeBg}>
                                            <input required type="text" name="Name" id="Name"
                                                autocomplete="off" className='input_width' ref={changeBg} onClick={changeBgFun} />
                                        </label>
                                    </div>
                                    <div className="Email feild_container " ref={changeBg}>
                                        <legend> E-mail*</legend>
                                        <label htmlFor="E-mail" className="label" ref={changeBg}>
                                            <input required type="email" name="E-mail" id="E-mail"
                                                autoComplete="off" className='input_width' ref={changeBg} onClick={changeBgFun} />
                                        </label>

                                    </div>
                                    <div className="Subject feild_container " ref={changeBg}>
                                        <legend>Subject *</legend>
                                        <label htmlFor="Subject" className="label" ref={changeBg}>
                                            <input required type="Subject" name="Subject" id="Subject"
                                                autoComplete="off" className='input_width' ref={changeBg} onClick={changeBgFun} />
                                        </label>

                                    </div>
                                    <div className="Massage feild_container " ref={changeBg} >
                                        <legend> Massage*</legend>
                                        <label htmlFor="Subject" className="label">
                                            <textarea title="Massage" name="Massage" id="Massage" autoComplete="off" ref={changeBg} className='input_width' onClick={changeBgFun}></textarea>
                                        </label>
                    ...
                    <div className="Contact_flex_inner_container" data-aos="fade-right" data-aos-duration='1000'>
