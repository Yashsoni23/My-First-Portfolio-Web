    ...
    return (
        <>
            ...
            <div className="SliderBox">
                <div className="sm_Container" data-aos="fade-right" data-aos-duration="1500">
                    ...
                    <div className="slides">
                        <div className="slide1 ">
                            {imgData.map((obj, index) => {
                                ...
                                return (
                                    <>
                                        <div key={obj.id} className='slide2 slide_2 ' data-aos="zoom-in" data-aos-duration="1000">
                                            <img src={`/images/sketches/img${SlideIndex}.jpg`} alt="images" className="Slide Slide_Home mobile" data-aos="zoom-in" data-aos-duration="1000"/>
                                        </div>
                                    </>
                                )
                            })}
                        ...
                        <div className="slide2 mobile_slide">
                            {imgData.map((obj, index) => {
                                ...
                                return (
                                    <>
                                        <div key={obj.id} className='slide2 mobile_slide2 ' data-aos="zoom-in" data-aos-duration="1000">
                                            <img src={`/images/sketches/img${SlideIndex2}.jpg`} alt="images" className="Slide "  data-aos="zoom-in" data-aos-duration="1000"/>
                                        </div>
                                    </>
                                )
                            })}
